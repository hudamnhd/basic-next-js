...
export const metadata = {
  title: "Incremental Static Regeneration Fetching - Unsplash Galery",
};
    ...
    <div className="space-y-8">
      <div className="p-3 rounded-md bg-blue-100 text-blue-600 w-[500px]">
        <p>
          ...
          image is fetched every 15 second ( after refreshing the page) and the
          served frin the cache for that duration.
        </p>
      </div>
      <Image
        src={image.urls.raw}
